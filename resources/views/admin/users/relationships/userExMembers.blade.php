...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userExMembers">
                <thead>
                    <tr>
                        <th width="10">
...
<script>
  ...
  let table = $('.datatable-userExMembers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
