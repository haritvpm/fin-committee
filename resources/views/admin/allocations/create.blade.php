    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.allocations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allotted_amount') ? 'is-invalid' : '' }}" type="number" name="allotted_amount" id="allotted_amount" value="{{ old('allotted_amount', '200000') }}" step="0.01" required>
